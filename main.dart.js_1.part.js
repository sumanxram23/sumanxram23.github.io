...
break A}if("views.home.greeting"===e){x=new A.aUH()
...
if("sidebar.batteryLabel"===e){x=new A.aUI()
break A}if("sidebar.batteryCharging"===e){x=new A.aUJ()
...
break A}if("common.secondsUnit"===e){x=new A.aUK()
...
break A}if("performance.dpiLevel"===e){x=new A.aUL()
...
break A}if("actions.button"===e){x=new A.aUM()
...
break A}if("actions.macroPlay"===e){x=new A.aUN()
